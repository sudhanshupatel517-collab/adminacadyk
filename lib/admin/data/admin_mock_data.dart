...
class AdminMockData {
  ...
  static final List<ManagedContent> content = [
    ...
    ManagedContent(id: 'p-4', authorName: 'Unknown User', authorEmail: 'spam@external.com', content: 'Buy cheap followers and likes! Visit our site now for amazing deals on social media growth...', postType: 'text', status: 'flagged', likeCount: 1, commentCount: 0, reportCount: 12, createdAt: DateTime.now().subtract(const Duration(hours: 8))),
    ...
    ManagedContent(id: 'p-7', authorName: 'Rohit Desai', authorEmail: 'rohit@acadyk.edu', content: 'This platform is terrible and the faculty are incompetent. Worst college experience.', postType: 'text', status: 'flagged', likeCount: 2, commentCount: 5, reportCount: 8, createdAt: DateTime.now().subtract(const Duration(days: 3))),
  ];
  ...
  static final List<ActivityLogEntry> activityLog = [
    ...
    ActivityLogEntry(id: 'a-6', action: 'Content removed', performedBy: 'Ananya Roy', target: 'Post p-9', timestamp: DateTime.now().subtract(const Duration(days: 3)), category: 'content'),
