...
class AdminMockData {
  ...
  static final List<ManagedUser> users = [
    ManagedUser(
      id: 'u-1',
      fullName: 'Sudhanshu Patel',
      email: 'sudhanshu@acadyk.edu',
      role: 'STUDENT',
      status: 'active',
      ...
      batch: '2025-2029',
      phone: '9876543210',
      dateOfBirth: DateTime(2006, 5, 14),
      fatherName: 'Ramesh Patel',
      fatherMobile: '9826012345',
      currentAddress: 'H-402, Nilgiri Hostel, MITS-DU Campus, Gwalior, Madhya Pradesh - 474005',
      admissionDate: DateTime(2025, 7, 20),
      registrationDate: DateTime(2025, 7, 20),
      clubIds: ['org-1', 'org-3'],
      teamIds: ['org-5'],
      eventIds: ['ev-1', 'ev-2'],
    ...
    ManagedUser(
      ...
      batch: '2025-2029',
      phone: '9876543211',
      dateOfBirth: DateTime(2006, 8, 22),
      fatherName: 'Suresh Sharma',
      fatherMobile: '9826023456',
      currentAddress: 'Room 214, Shivalik Block, MITS-DU Campus, Gwalior, Madhya Pradesh - 474005',
      admissionDate: DateTime(2025, 7, 22),
      registrationDate: DateTime(2025, 7, 22),
      clubIds: ['org-1'],
      teamIds: [],
      eventIds: ['ev-1', 'ev-3'],
    ...
    ManagedUser(
      id: 'u-3',
      fullName: 'Ananya Roy',
      email: 'ananya@acadyk.edu',
      role: 'STUDENT',
      status: 'active',
      department: 'Information Technology',
      enrollmentNumber: 'BTIT25O1008',
      course: 'B.Tech',
      branch: 'IT',
      year: 1,
      semester: 2,
      batch: '2025-2029',
      phone: '9876543212',
      dateOfBirth: DateTime(2006, 11, 30),
      fatherName: 'Debashis Roy',
      fatherMobile: '9826034567',
      currentAddress: 'Flat 3B, Saraswati Girls Hostel, Gwalior, Madhya Pradesh - 474005',
      admissionDate: DateTime(2025, 7, 18),
      registrationDate: DateTime(2025, 7, 18),
      clubIds: ['org-2'],
      teamIds: ['org-6'],
      eventIds: ['ev-2'],
    ...
    ManagedUser(
      ...
      fatherName: 'Late Mohan Lal Verma',
      fatherMobile: '9826045678',
      currentAddress: 'Quarter B-12, Faculty Enclave, MITS-DU Campus, Gwalior, Madhya Pradesh - 474005',
      admissionDate: DateTime(2018, 6, 1),
      registrationDate: DateTime(2018, 6, 1),
      clubIds: [],
      teamIds: [],
      eventIds: ['ev-1'],
    ...
    ManagedUser(
      id: 'u-5',
      fullName: 'Priya Nair',
      email: 'priya@acadyk.edu',
      role: 'STUDENT',
      status: 'suspended',
      department: 'Electronics & Communication',
      enrollmentNumber: 'BTEC24O1022',
      course: 'B.Tech',
      branch: 'ECE',
      year: 2,
      semester: 4,
      ...
      fatherName: 'K. N. Nair',
      fatherMobile: '9826056789',
      currentAddress: 'House No. 124, City Center, Gwalior, Madhya Pradesh - 474011',
      admissionDate: DateTime(2024, 7, 25),
      registrationDate: DateTime(2024, 7, 25),
      suspensionReason: 'Academic misconduct',
      suspendedAt: DateTime.now().subtract(const Duration(days: 14)),
      suspendedBy: 'Sudhanshu Patel',
      clubIds: [],
      teamIds: [],
      eventIds: [],
    ...
    ManagedUser(
      ...
      email: 'siddharth@acadyk.edu',
      role: 'STUDENT',
      status: 'active',
      department: 'Mechanical Engineering',
      enrollmentNumber: 'BTME24O1045',
      course: 'B.Tech',
      branch: 'ME',
      year: 2,
      semester: 3,
      batch: '2024-2028',
      phone: '9876543214',
      dateOfBirth: DateTime(2005, 4, 12),
      fatherName: 'Vijay Mehta',
      fatherMobile: '9826067890',
      currentAddress: 'Sector 4, Gandhi Nagar, Gwalior, Madhya Pradesh - 474002',
      admissionDate: DateTime(2024, 7, 28),
      registrationDate: DateTime(2024, 7, 28),
      clubIds: ['org-4'],
      teamIds: [],
      eventIds: ['ev-3'],
    ...
    ManagedUser(
      id: 'u-7',
      fullName: 'Kavya Iyer',
      email: 'kavya@acadyk.edu',
      role: 'STUDENT',
      status: 'active',
      department: 'Computer Science & Engineering',
      enrollmentNumber: 'BTCS24O1033',
      course: 'B.Tech',
      branch: 'CSE',
      year: 2,
      semester: 4,
      batch: '2024-2028',
      phone: '9876543215',
      dateOfBirth: DateTime(2005, 12, 5),
      fatherName: 'V. Sundaram Iyer',
      fatherMobile: '9826078901',
      currentAddress: 'Flat 4A, Ganga Hostel, MITS-DU Campus, Gwalior, Madhya Pradesh - 474005',
      admissionDate: DateTime(2024, 7, 20),
      registrationDate: DateTime(2024, 7, 20),
      clubIds: ['org-1', 'org-2'],
      teamIds: ['org-5'],
    ...
    ManagedUser(
      ...
      email: 'rohit@acadyk.edu',
      role: 'STUDENT',
      status: 'active',
      department: 'Civil Engineering',
      enrollmentNumber: 'BTCE23O1012',
      course: 'B.Tech',
      branch: 'Civil',
      year: 3,
      semester: 5,
      batch: '2023-2027',
      phone: '9876543216',
      dateOfBirth: DateTime(2004, 7, 19),
      fatherName: 'Prakash Desai',
      fatherMobile: '9826089012',
      currentAddress: 'Plot 55, Anand Nagar, Gwalior, Madhya Pradesh - 474012',
      admissionDate: DateTime(2023, 7, 15),
      registrationDate: DateTime(2023, 7, 15),
      clubIds: ['org-4'],
      teamIds: [],
      eventIds: [],
    ...
    ManagedUser(
      ...
      fatherName: 'R. K. Joshi',
      fatherMobile: '9826090123',
      currentAddress: 'Quarter C-4, Staff Colony, MITS-DU Campus, Gwalior, Madhya Pradesh - 474005',
      admissionDate: DateTime(2021, 8, 1),
      registrationDate: DateTime(2021, 8, 1),
      clubIds: [],
      teamIds: [],
      eventIds: ['ev-2'],
    ...
    ManagedUser(
      ...
      email: 'vikram@acadyk.edu',
      role: 'STUDENT',
      status: 'banned',
      department: 'Electronics & Communication',
      enrollmentNumber: 'BTEC23O1041',
      course: 'B.Tech',
      branch: 'ECE',
      year: 3,
      semester: 6,
      batch: '2023-2027',
      phone: '9876543217',
      dateOfBirth: DateTime(2004, 2, 16),
      fatherName: 'Balwant Singh',
      fatherMobile: '9826101234',
      currentAddress: 'Vill. Morar, Gwalior, Madhya Pradesh - 474006',
      admissionDate: DateTime(2023, 7, 18),
      registrationDate: DateTime(2023, 7, 18),
      suspensionReason: 'Repeated policy violations',
      suspendedAt: DateTime.now().subtract(const Duration(days: 30)),
      suspendedBy: 'Sudhanshu Patel',
      clubIds: [],
      teamIds: [],
      eventIds: [],
    ...
    ManagedUser(
      id: 'u-11',
      fullName: 'Neha Gupta',
      email: 'neha@acadyk.edu',
      role: 'STUDENT',
      status: 'active',
      department: 'Computer Science & Engineering',
      enrollmentNumber: 'BTAM25O1078',
      course: 'B.Tech',
      branch: 'AIML',
      year: 1,
      semester: 2,
      batch: '2025-2029',
      phone: '9876543218',
      dateOfBirth: DateTime(2006, 6, 11),
      fatherName: 'Alok Gupta',
      fatherMobile: '9826112345',
      currentAddress: 'Flat 201, Shanti Niketan Apartments, Lashkar, Gwalior, Madhya Pradesh - 474001',
      admissionDate: DateTime(2025, 7, 24),
      registrationDate: DateTime(2025, 7, 24),
      clubIds: ['org-1', 'org-3'],
      teamIds: ['org-6'],
      eventIds: ['ev-1'],
    ...
    ManagedUser(
      ...
      email: 'arjun@acadyk.edu',
      role: 'STUDENT',
      status: 'active',
      department: 'Mechanical Engineering',
      enrollmentNumber: 'BTME23O1028',
      course: 'B.Tech',
      branch: 'ME',
      year: 3,
      semester: 6,
      batch: '2023-2027',
      phone: '9876543219',
      dateOfBirth: DateTime(2004, 9, 27),
      fatherName: 'Sanjay Kapoor',
      fatherMobile: '9826123456',
      currentAddress: 'House 88, Thatipur, Gwalior, Madhya Pradesh - 474011',
      admissionDate: DateTime(2023, 7, 20),
      registrationDate: DateTime(2023, 7, 20),
      clubIds: ['org-4'],
      teamIds: ['org-7'],
      eventIds: ['ev-3'],
      joinedAt: DateTime(2024, 3, 28),
      lastActive: DateTime.now().subtract(const Duration(days: 2)),
      postsCount: 11,
    ),
    ManagedUser(
      id: 'u-13',
      fullName: 'Dr. Amit Saxena',
      email: 'amit.saxena@acadyk.edu',
      role: 'FACULTY',
      status: 'active',
      ...
      phone: '9876543222',
      dateOfBirth: DateTime(1982, 1, 15),
      fatherName: 'G. P. Saxena',
      fatherMobile: '9826134567',
      currentAddress: 'Quarter A-8, Faculty Enclave, MITS-DU Campus, Gwalior, Madhya Pradesh - 474005',
      admissionDate: DateTime(2019, 7, 1),
      registrationDate: DateTime(2019, 7, 1),
      clubIds: [],
      teamIds: [],
      eventIds: [],
    ...
    ManagedUser(
      id: 'u-14',
      fullName: 'Riya Patel',
      email: 'riya@acadyk.edu',
      role: 'STUDENT',
      status: 'active',
      department: 'Electrical Engineering',
      enrollmentNumber: 'BTEE24O1019',
      course: 'B.Tech',
      branch: 'EE',
      year: 2,
      semester: 3,
      ...
      fatherMobile: '9826145678',
      currentAddress: 'Flat 12, Yamuna Hostel, MITS-DU Campus, Gwalior, Madhya Pradesh - 474005',
      admissionDate: DateTime(2024, 7, 22),
      registrationDate: DateTime(2024, 7, 22),
      clubIds: ['org-2', 'org-3'],
      teamIds: [],
      eventIds: ['ev-2'],
